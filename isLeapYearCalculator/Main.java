...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("test: " + isLeapYear(2020));
    ...
    //Every year that is evenly divisible by four is a leap year except for years that are evenly divisible
// by 100 and not evenly divisible by 400
